...
export default async function HeroSection() {
	return (
		<div className="relative min-h-fit md:min-h-screen">
			<div className="absolute inset-0 -z-20 bg-gradient-to-b from-[#f6cfb212] to-[#9d4e9a12]" />
				...
				<div className="mt-10 flex w-full flex-col items-center justify-between md:flex-row xl:mt-20 xl:px-28 xl:py-16">
					<div className="flex place-items-center gap-x-4">
						<MagneticButtonWrapper>
							<button
								type="button"
								className="text-lg background-clip[padding-box] w-fit rounded-full bg-[#FAC4A2] px-[35px] py-[50px] font-semibold transition-all duration-300 hover:bg-[#FAC4A2] hover:shadow-[0_0_0_4px_#FAC4A2] focus:outline-none focus:ring-2 focus:ring-[#FAC4A2] focus:ring-offset-2"
							>
								CHAPA
							</button>
						</MagneticButtonWrapper>
						<p className="max-w-80">
							{/* //* Random chatgpt generate text :p */}
					...
					<div className="mt-8 md:mt-0">
						<div className="group mb-8 flex place-items-center gap-x-4 text-center">
							...
							>
								New Collections
								<span className="absolute bottom-0 left-0 h-1 scale-x-0 transform bg-black transition-all duration-1000 group-hover:scale-x-100" />
							</Link>
